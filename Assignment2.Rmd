...
H_0: \beta_month=0
H_1: \beta_month =\= 0
with alpha = 0.05. t-statistic = 0.572, p-value = 0.568 and df = 251. Two-tailed critical value = +/- 1.97. Therefore, since the critical value of two tailed test is larger than t-value, we fail to reject null hypothesis that the coefficient that belong to month of release is zero.
